...
export default function ContactPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-black text-white">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="mt-4 text-xl text-gray-300 max-w-3xl mx-auto">
              Have a project in mind? Looking to collaborate? We'd love to hear from you.
            </p>
          </div>
        </div>
      </div>
      ...
      {/* Contact Content */}
      <div className="py-16 bg-black flex-grow">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div>
              ...
              <div className="space-y-8">
                <ContactInfoItem 
                  ...
                  content={(
                    <a 
                      href="mailto:clomaproduction@gmail.com" 
                      className="text-gray-300 hover:text-primary"
                    >
                      clomaproduction@gmail.com
                    </a>
                  )}
                />
                ...
                <ContactInfoItem 
                  ...
                  title="Phone"
                  content={<span className="text-gray-300">+2349129426172</span>}
                />
                
                <ContactInfoItem 
                  icon={<MapPin className="h-6 w-6 text-primary" />}
                  title="Location"
                  content={<span className="text-gray-300">Lagos, Nigeria</span>}
                />
              </div>
